...
BUILD       	:=  build
LIBBUTANO   	:=  ../butano-master/butano-master/butano
PYTHON      	:=  C:/Users/ametc/AppData/Local/Python/bin/python.exe
SOURCES     	:=  src
INCLUDES    	:=  include gba-link-connection/lib
DATA        	:=
GRAPHICS    	:=  graphics
AUDIO       	:=  audio
AUDIOBACKEND	:=  maxmod
